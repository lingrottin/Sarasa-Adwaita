...
This project incorporates and derives from works by the copyright holders listed below. Copyright in those works remains with their respective copyright holders.

I do not claim copyright in my original contributions to this project.
...
The font files generated by this project are licensed under the SIL Open Font License, Version 1.1. See [LICENSE](./LICENSE) for the applicable copyright notices and license terms.

The build scripts, configuration files, and other original source code used to build the fonts are released into the public domain under The Unlicense. See [UNLICENSE](./UNLICENSE).

These licenses apply only to the respective materials described above and do not change the copyright or licensing terms of any third-party works incorporated into this project.
